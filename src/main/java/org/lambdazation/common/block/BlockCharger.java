...
public final class BlockCharger extends BlockContainer {
	...
	public BlockCharger(Lambdazation lambdazation, Properties properties) {
		super(properties);
	...
	public void onReplaced(IBlockState state, World worldIn, BlockPos pos, IBlockState newState, boolean isMoving) {
		if (state.getBlock() != newState.getBlock()) {
			...
			if (tileentity instanceof TileEntityCharger) {
				InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityCharger) tileentity);
	...
	public boolean onBlockActivated(IBlockState state, World worldIn, BlockPos pos, EntityPlayer player, EnumHand hand,
		...
		NetworkHooks.openGui(entityPlayerMP, tileEntityCharger, pos);
	...
	public TileEntity createNewTileEntity(IBlockReader worldIn) {
		return new TileEntityCharger(lambdazation);
	}
