...
public final class BlockTransformer extends BlockContainer {
	...
	public BlockTransformer(Lambdazation lambdazation, Properties properties) {
		super(properties);
	...
	public void onReplaced(IBlockState state, World worldIn, BlockPos pos, IBlockState newState, boolean isMoving) {
		if (state.getBlock() != newState.getBlock()) {
			...
			if (tileentity instanceof TileEntityTransformer) {
				InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityTransformer) tileentity);
	...
	public boolean onBlockActivated(IBlockState state, World worldIn, BlockPos pos, EntityPlayer player, EnumHand hand,
		...
		NetworkHooks.openGui(entityPlayerMP, tileEntityTransformer, pos);
	...
	public TileEntity createNewTileEntity(IBlockReader worldIn) {
		return new TileEntityTransformer(lambdazation);
	}
